...
while selected_file_number != 5:
    if selected_file_number == 1:
        ...
        print("The program detail")
        print("In the mini project, I built the program to search Fiction from dictionary by insert Fiction Code with many topics in If-else, While Loop, Dictionary and File Handling. The program will show Fiction Detail including View, Fiction Type, etc. You also use program to creates CSV file or JSON file by the dictionary of fiction detail.")
        print("--------------------------------------------------------------------")
        print("MENU \n If you want JSON File,select 1. \n If you want CSV File,select 2. \n Want to see the program detail,select 3. \n You want to see fiction data,select 4. \n You want to stop the program,select 5.")
        selected_file_number = int(input("Enter the number : "))
